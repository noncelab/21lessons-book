...
그 심오함을 깨닫기까지 꽤 오랜 시간이 걸렸다.
비트코인은 소프트웨어일 뿐이고 모든 것이 오픈 소스이기 때문에 마음대로 변경할 수 있는 것 아닌가? 
틀렸다. 이것은 매우 잘못된 생각이다. 
당연히 비트코인 창시자도 이를 사실을 잘 알고 있었다.
...
\begin{quotation}\begin{samepage}
		...
		사람들은 비트코인으로 지불할 수 있기 때문에 살아있다. [\ldots] 비트코인은 변하지 않는다. 논쟁의 여지가 없다.
		조작될 수도, 손상될 수도, 멈출 수도 없다. [\ldots] 핵전쟁으로 지구 절반이 파괴되어도 부패하지 않고 살아남을 것이다. }
